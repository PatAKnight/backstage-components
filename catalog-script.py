...
def save_yaml_file(name, content, number, folder_structure):
...
def create_resources():
  for group_number in range(2):
      ...
      save_yaml_file(vegetable_name, group_yaml_content, group_number, GROUP_FOLDER_STRUCTURE)
      GROUP_CHOICES.append(f"{vegetable_name}-{group_number}")

      for system_number in range(2):
        ...
        save_yaml_file(snake_name, system_yaml_content, system_number, SYSTEM_FOLDER_STRUCTURE)
        SYSTEM_CHOICES.append(f"{snake_name}-{system_number}")

      for api_number in range(2):
        ...
        save_yaml_file(mammal_name, api_yaml_content, api_number, API_FOLDER_STRUCTURE)
        API_CHOICES.append(f"{mammal_name}-{api_number}")

      for resource_number in range(2):
        ...
        save_yaml_file(fish_name, resource_yaml_content, resource_number, RESOURCES_FOLDER_STRUCTURE)
        RESOURCE_CHOICES.append(f"resource:{fish_name}-{resource_number}")

      for component_number in range(2):
        ...
        save_yaml_file(bird_name, component_yaml_content, component_number, COMPONENTS_FOLDER_STRUCTURE)
      ...
      for user_number in range(2):
        ...
        save_yaml_file(fruit_name, user_yaml_content, user_number, USER_FOLDER_STRUCTURE)
  ...
  for i in range(len(LOCATIONS)):
    ...
    save_yaml_file(LOCATIONS[i], location_yaml_content, 1, LOCATION_FOLDER_STRUCTURE)
